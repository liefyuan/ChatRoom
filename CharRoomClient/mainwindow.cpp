...
void MainWindow::noticeAllClient_Slots(QString thisProgramUserName, QString userEnterMsg)
{
    if (userNameSwitch)
    {
        //设置名字
...
void MainWindow::updateAllUser_Slots(QString userAccountName, QString userComputerIP)
{
...
//接收服务器传来的聊天消息的槽函数
void MainWindow::chatMessage_Slots(QString message)
{
...
//发送消息
void MainWindow::sendMessageBtn_Slots()
{
...
void MainWindow::userExit_Slots(QString userExitName, QString userExitMsg)
{
    //用户离开聊天室信息
